...
-- util.AddNetworkString("Radio:AddMusicPlaylist")
-- local function AddMusicPlaylist(len, ply)
--     if !ply:IsValid() then return end
    
--     local ent = net.ReadEntity()
--     local url = net.ReadString()

--     ent:AddMusicPlaylist(ply, url)
-- end
-- net.Receive("Radio:AddMusicPlaylist", AddMusicPlaylist)

-- util.AddNetworkString("Radio:RemoveMusicPlaylist")
-- local function RemoveMusicPlaylist(len, ply)
--     if !ply:IsValid() then return end
    
--     local ent = net.ReadEntity()
--     local id  = net.ReadUInt(16)

--     ent:RemoveMusicPlaylist(ply, id)
-- end
-- net.Receive("Radio:RemoveMusicPlaylist", RemoveMusicPlaylist)

-- util.AddNetworkString("Radio:UpdateMusicPlaylist")

...
function PANEL:MakeContent(ent)
	...
	Title:SetText( "Title : "..radio:GetNWString("Radio:Title") )
	Title:SetTextColor(Radio.Color["text"])
	Title:SetFont("Radio.Menu")
	Title.Think = function(self)
		if ent.Playing then
			self:SetText( "Title : "..radio:GetNWString("Radio:Title") )
	...
	Author:SetText( "Author : "..radio:GetNWString("Radio:Author") )
	...
	Author.Think = function(self)
		if ent.Playing and radio:GetNWString("Radio:Mode") != "3" then
			self:SetText( "Author : "..radio:GetNWString("Radio:Author") )

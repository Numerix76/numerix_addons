...
function PANEL:MakeContent(ent)
	...
	Connect:SetPos( 0, self:GetTall() - 30 )
	...
	Connect:SetSize( self:GetWide()/2-5, 25 )
	...
	Disconnect:SetPos( self:GetWide()/2 + 5, self:GetTall() - 30 )
	...
	Disconnect:SetSize( self:GetWide()/2-5, 25 )
